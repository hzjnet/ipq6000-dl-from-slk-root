/*
 * Copyright (c) 2004 - 2020 Qualcomm Technologies, Inc. All Rights Reserved.
 * All Rights Reserved.
...
parse_unifiedcmd (A_UINT8 *buffer, A_UINT16 dataLen)
{
    ...
    {
#if defined(DBGLOG_FTM_SUPPORT)
        DBGLOG_RECORD_LOG(WLAN_MODULE_FTM, -1, FTM_DBGID_WMI_INIT_RECVD, DBGLOG_UTF, 2, dataLen , sizeof(segHdrInfo));
#endif
        return;
    }
