...
$Header: //components/rel/wlanfw_halphy_tools.cnss/1.0/target/utf/tcmd_utf/tcmd.c#73 $
...
#if defined(DBGLOG_FTM_SUPPORT)
 //DBGLOG_RECORD_LOG(WLAN_MODULE_FTM, -1, FTM_DBGID_SETUP_CHANNEL, DBGLOG_UTF, 5, 0xD1D1,rate_index, TCMD_MAX_RATES, rsStatus, tcmd_state.tcmdRxGo);
#endif
...
//            A_PRINTF_ALWAYS("clpcpkt mode d\n");
        ...
        case TCMD_CONT_TX_TX99:
            ...
            //contTx->numPackets = 0;
#if defined(DBGLOG_FTM_SUPPORT)
			//DBGLOG_RECORD_LOG(WLAN_MODULE_FTM, -1, FTM_DBGID_SETUP_CHANNEL, DBGLOG_UTF, 5, 0xDBDB, contTx->numPackets, contTx->pktSz, contTx->agg, contTx->dataRate);
#endif
#if 1
